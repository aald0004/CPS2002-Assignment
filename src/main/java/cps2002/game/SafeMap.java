...
public class SafeMap implements Map {
     ...
     * Returns:   HazardousMap-> the private safe map instance*/
    public static SafeMap getInstance(int numOfPlayers){
        if(instance == null){
            instance = new SafeMap(numOfPlayers);
        }
    ...
    public void addWaterTiles(){
        ...
        double randomNum = (0.1)*rand.nextDouble();

        // around 10% of the map will be filled with water tiles
